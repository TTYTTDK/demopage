...
// Parse the Data
d3.csv("data/Single_Stock_RMSE_Bar_Data/Metrics_Score_rmse_5609TWO.csv").then( function(data) {
   ...
   svg1.selectAll("mybar")
      ...
      .on("mouseover", function (e, d, i){
         ...
         d3.select(`#line2chart-${tempid[1]}`).attr("opacity", 1);
      ...
      .on("mouseout", function(d){
         ...
         // interactive with line
         let tempid = this.id.split("-");
         d3.select(`#line2chart-${tempid[1]}`).attr("opacity", 0.1);
...
//load data
d3.csv('data/Line_Chart_Data/data_折線/5609.TWO.csv',type).then( data => {
   ...
   stock.append("path")
         ...
         .on("mouseover", function(d){
            ...
            if (this.id != "line2chart-Historical") {
