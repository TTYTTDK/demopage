...
const colors = [
         "#1f2a13", "#293819", "#344620", "#3f5427", "#49622d",
         "#547033", "#5e7e3a", "#698c40", "#739a47", "#7da84d",
...
const svg = d3.select(`#oil_pie`) //create Svg element
            .append("svg")
...
const tooltip = d3.select(`#oil_pie`)
            .append('div')
...
d3.csv(`data/Pie_Chart/oil_adj.csv`).then( function(data) {
